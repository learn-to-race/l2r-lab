...
from src.encoders.segmentation_model.configs.machine_config import MachineConfig
from src.encoders.segmentation_model.loader import build_loader
from src.encoders.segmentation_model.loader.depth_estimator import DepthEstimator
from src.encoders.segmentation_model.loss import get_monodepth_loss
from src.encoders.segmentation_model.models import get_model
from src.encoders.segmentation_model.train import setup_seeds, expand_cfg_vars


class Inference():
    def __init__(self):
        mypath = os.path.abspath('./') + '/src/encoders/segmentation_model/'
        checkpoint_file =  mypath + "best_model_without_opt.pkl"
        cfg_file =  mypath + "cfg.yml"
        ...
        # Setup Model
        self.model = get_model(cfg["model"], 19).to(self.device)
        # print(self.model)
